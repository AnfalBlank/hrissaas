  ...
  try {
    ...
    const rows = await db
      .select({
        ...
        checkInMethod: schema.attendances.checkInMethod,
        checkInLat: schema.attendances.checkInLat,
        checkInLng: schema.attendances.checkInLng,
        checkInPhotoUrl: schema.attendances.checkInPhotoUrl,
        checkInConfidence: schema.attendances.checkInConfidence,
        ...
        branchLatitude: schema.branches.latitude,
        branchLongitude: schema.branches.longitude,
        branchRadiusMeters: schema.branches.radiusMeters,
      })
