...
export default function ProfilePage() {
  ...
  const SECTIONS: {
    ...
    },
    {
      title: "Keamanan",
      items: [
        { icon: "shield", label: "Device Saya", sub: "Kelola perangkat" },
        { icon: "lock", label: "PIN & Biometric", sub: "Kunci aplikasi" },
        { icon: "scroll", label: "Audit Log", sub: "Aktivitas akun" },
      ],
    },
    {
      title: "Lainnya",
      items: [
        { icon: "bell", label: "Notifikasi", sub: "Atur preferensi" },
        { icon: "globe", label: "Bahasa", sub: "Indonesia" },
        { icon: "light", label: "Mode Tampilan", sub: "Sistem" },
        { icon: "chat", label: "Pusat Bantuan", sub: "FAQ & dukungan" },
      ],
    },
  ];
